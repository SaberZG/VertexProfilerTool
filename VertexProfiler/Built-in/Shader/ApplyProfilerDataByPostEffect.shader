Shader "VertexProfiler/ApplyProfilerDataByPostEffect"
{
	Properties
	{
...
//		Tags { "RenderType"="Opaque" }
		Pass
		{
			...
			half4 frag (v2f i) : SV_Target
			{
				...
				{
					int2 rendererIdAndVertexCount = tex2D(_RendererIdAndVertexCountRT, i.uv).rg; // r:RendererId + 1(使用时需要-1) g:VertexCount
